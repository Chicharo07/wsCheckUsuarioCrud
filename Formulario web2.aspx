    ...
    <table width="70%" border="0">
        <tr>
            ...
            <td width="70%">
                ...
                <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/imagenes/icon_edit.GIF" OnClick="ImageButton5_Click1" />
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:TextBox ID="TextBox5" runat="server" MaxLength="8" Width="50px"></asp:TextBox>
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:TextBox ID="TextBox6" runat="server" MaxLength="8" Width="50px"></asp:TextBox>
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:TextBox ID="TextBox7" runat="server" MaxLength="40" Width="50px"></asp:TextBox>
