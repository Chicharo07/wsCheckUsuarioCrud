...
namespace wsCheckUsuario
{
    public partial class Formulario_web2 : System.Web.UI.Page
    {
        ...
        private async Task cargaDatosTipoUsuario()
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    string apiUrl = "https://localhost:44309/check/usuario/vwmtipoUsuario";
                    ...
                    if (respuesta.IsSuccessStatusCode)
                    {
                        ...
                        DropDownList1.DataTextField = "Rol";
        ...
        private async Task cargaDatos()
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    string apiUrl = "https://localhost:44309/check/usuario/spinsusuario";
                    // ----------------------------------------------
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    HttpContent contenido = new StringContent
                                (data, Encoding.UTF8, "application/json");
                    // Ejecución de la petición HTTP
                    string apiUrl = "https://localhost:44309/check/usuario/spDelUsuario";
                    // ----------------------------------------------
                    HttpResponseMessage respuesta =
                        await client.PostAsync(apiUrl, contenido);
                    // ---------------------------------------------------
        ...
        private async Task consultaUsuarioPorClave()
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    string apiUrl = $"https://localhost:44309/check/usuario/vwRptUsuariocve?filtro={TextBox1.Text}";
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    HttpContent contenido = new StringContent
                                (data, Encoding.UTF8, "application/json");
                    // Ejecución de la petición HTTP
                    string apiUrl = "https://localhost:44309/check/usuario/spUpdUsuario";
                    // ----------------------------------------------
                    HttpResponseMessage respuesta =
                        await client.PostAsync(apiUrl, contenido);
                    // ---------------------------------------------------
                    ...
                    if (respuesta.IsSuccessStatusCode)
                    {
                        ...
                        Response.Write(objRespuesta.ban);
                        Response.Write(objRespuesta.datos.ToString());
        ...
        protected async void ImageButton5_Click1(object sender, ImageClickEventArgs e)
        {
            if (TextBox1.Text == "")
            {
                Response.Write("<script language='javascript'>" +
